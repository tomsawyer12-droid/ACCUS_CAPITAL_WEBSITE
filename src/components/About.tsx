            ...
            <div className="relative z-10">
              ...
              >
                <div className="flex items-center space-x-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#00A99D] to-[#008B82] rounded-full flex items-center justify-center">
                    <CheckCircle className="text-white" size={32} />
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-[#00A99D]">Licensed</div>
                    <div className="text-gray-600">Bank of Uganda</div>
                  </div>
                </div>
              </motion.div>
            </div>
